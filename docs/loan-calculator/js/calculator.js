...
function updateResults(loanDetails) {
    ...
    loanDetailsList.innerHTML = `
        ...
        ${loanDetails.fixed_period_years ? `<li class="list-group-item">Fixed Interest Period: ${loanDetails.fixed_period_years} years</li>` : ''}
    `;
    ...
    paymentSummaryList.innerHTML = `
        ...
        ${loanDetails.fixed_period_years ? `<li class="list-group-item">Remaining After Fixed Period: ${formatCurrency(loanDetails.fixed_period_remaining+loanDetails.annual_extra_payment)}</li>` : ''}
